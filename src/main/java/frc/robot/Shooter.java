...
public class Shooter extends SubsystemBase {
    ...
    private final SysIdRoutine m_sysIdRoutine = new SysIdRoutine(
            ...
            new SysIdRoutine.Mechanism(
                    ...
                    this));
    // PID controller to run the shooter wheel in closed-loop, set the constants
    // equal to those
    // calculated by SysId
    private final PIDController m_shooterFeedback = new PIDController(ShooterConstants.kP, 0, 0);
    // Feedforward controller to run the shooter wheel in closed-loop, set the
    // constants equal to
    ...
    public Command runShooter(DoubleSupplier shooterSpeed) {
        // Run shooter wheel at the desired speed using a PID controller and
        // feedforward.
        return run(() -> {
